...
{block name='page_content'}
          ...
          <div class="row align-items-center">
            <div class="col">
              <strong>
                ...
                {l s='Order' d='Shop.Theme.Customeraccount'} : {hook h="displayPrettyOrderId" ref_order=$order.details.reference} - {$order.details.order_date}
 ...
 {/block}
  ...
  {hook h='displayOrderTrackings' order=$order }
