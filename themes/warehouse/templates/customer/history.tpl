    ...
    <table class="table table-striped table-bordered table-labeled table-responsive hidden-sm-down">
      ...
      <tbody>
        {foreach from=$orders item=order}
          <tr>
            <th scope="row">{*$order.details.reference*}{hook h="displayPrettyOrderId" ref_order=$order.details.reference}</th>
            ...
            <td class="text-center hidden-md-down">
              {if $order.details.invoice_url}
                <a href="{$order.details.invoice_url}" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
              {else}
                -
              {/if}
            </td>
