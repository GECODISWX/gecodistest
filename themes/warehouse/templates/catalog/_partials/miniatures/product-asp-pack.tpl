...
{if isset($elementor) && $elementor}<div class="{if isset($carousel) && $carousel}product-carousel{else}col-1 col-md-3 col-lg-3 col-xl-3{/if}">{/if}
    <article class="product-miniature product-miniature-small product-miniature-small-grid js-product-miniature" data-id-product="{$product.id_product}"
        ...
        <div class="row align-items-center list-small-gutters">
            {block name='product_thumbnail'}
                <div class="thumbnail-container col-12 col-sm-5">
            ...
            <div class="product-description col-12 col-sm-7">
                {block name='product_name'}
                    <h4 class="product-title" ><a
                                href="{$product.canonical_url}">{$product.name|truncate:80:'...'}</a></h4>
                {/block}
