...
<div class="product-add-cart">
        ...
        <form action="{$product.add_to_cart_url}" method="post">
            ...
            <div class="input-group-add-cart">
                ...
                ><i class="fa fa-shopping-bag fa-fw bag-icon"
                    aria-hidden="true"></i> <i class="fa fa-circle-o-notch fa-spin fa-fw spinner-icon" aria-hidden="true"></i><span> {l s='Add to cart' d='Shop.Theme.Actions'}</span>
                </button>
            </div>
    ...
    {else}
        ...
        > <i class="fa fa-shopping-bag fa-fw bag-icon"
            aria-hidden="true"></i><span> {l s='Add to cart' d='Shop.Theme.Actions'}</span>
        </a>
    {/if}
</div>
