    ...
    <div class="product-prices">
        ...
        {block name='product_price'}
            ...
            >
                ...
                <div>
                    <span class="current-price"><span itemprop="price" class="product-price" content="{$product.rounded_display_price}">{hook h="displayProductPrettyPrice" price=$product.price}{*$product.price*}</span></span>
