        ...
        <div class="col-sm-12 col-md-5 order-confirmation-details">
          ...
          {block name='order_details'}
            <div id="order-details">
              ...
              <ul>
                <li>{*l s='Order reference: %reference%' d='Shop.Theme.Checkout' sprintf=['%reference%' => $order.details.reference]*}{l s='Order reference: %reference%' d='Shop.Theme.Checkout' sprintf=['%reference%' => ""]}{hook h="displayPrettyOrderId" ref_order=$order.details.reference}</li>
                ...
                {if !$order.details.is_virtual}
                  ...
                  {hook h="displayOrderConfirmationAddresses" order=$order}
                {/if}
              </ul>
            </div>
          {/block}
