...
{if $status == 'ok'}
    ...
    {include file='module:ps_wirepayment/views/templates/hook/_partials/payment_infos_extra.tpl'}

    <p>
      {l s='Afin de valider votre commande' d='Modules.Wirepayment.Shop'}<br/>
      <span class="red">{$lastname} / {$reference}</span><br><br>
